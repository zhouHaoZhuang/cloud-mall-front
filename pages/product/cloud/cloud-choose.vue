<template>
  ...
  <div class="cloud">
    ...
    <Banner type="choose" />
    <!-- 产品优势 -->
    <div class="youshi-module auto">
      <p class="title">
        <span class="title-name"> 产品优势 </span>
      </p>
      <div class="adv-wrap">
        <ul class="clearfix">
          <li class="">
    ...
    <!-- 产品功能 -->
    <div class="gongneng-moudle">
      <div class="auto">
        <p class="title">
          <span class="title-name"> 产品功能 </span>
        </p>
        <div class="container">
          <div class="gongneng-left">
            <p class="left-title">
              01 计算
            </p>
    ...
    <!-- 优势对比 -->
    <div class="youshi-moudle">
      <div class="auto">
        <p class="title">
          <span class="title-name"> 优势对比 </span>
        </p>
        <div class="container">
          <div class="youshi-left box">
            <div class="line">
              服务器可用性(SLA)
            </div>
            <div class="line">
    ...
    <div class="yingyong-moudle">
      <div class="auto">
        ...
        <div class="container">
          ...
          <div class="yingyong-center">
            <div
              v-for="item in yingyong"
              v-show="curId === item.id"
              :key="item.id"
              class="yingyong-show"
            >
              <div class="yingyong-center-top">
                <p class="yingyong-center-title">
                  {{ item.titleone }}
                </p>
                {{ item.contentone }}
              </div>
              <div class="yingyong-center-bottom">
                <p class="yingyong-center-title">
                  {{ item.titletwo }}
                </p>
                {{ item.contenttwo }}
...
.gongneng-moudle {
  ...
  .container {
    ...
    .gongneng-left {
      ...
      height: 530px;
      padding: 0 48px;
      background: url(~/static/img/cloud/gongneng_left_bg.png) center no-repeat;
    ...
    .gongneng-right {
      ...
      .right-container:nth-child(1) {
        background: url(~/static/img/cloud/gongneng_right_bg1.png) center
          no-repeat;
      }
      .right-container:nth-child(2) {
        background: url(~/static/img/cloud/gongneng_right_bg2.png) center
          no-repeat;
      }
      .right-container:nth-child(3) {
        background: url(~/static/img/cloud/gongneng_right_bg3.png) center
          no-repeat;
      }
      .right-container:nth-child(4) {
        background: url(~/static/img/cloud/gongneng_right_bg4.png) center
          no-repeat;
      }
    }
  }
  ...
  .container {
    ...
    .youshi-right {
      ...
      .youshi-title {
        ...
        font-weight: 800;
        color: #ffffff;
        background: url(~/static/img/cloud/youshi-right-titlebg1.png) no-repeat
          center;
        background-size: cover;
      }
      .youshi-content {
    ...
    .youshi-right:nth-child(3) {
      background: url(~/static/img/cloud/youshi-right-content2.png) no-repeat
        bottom right;
      background-size: cover;
      .youshi-title {
        position: relative;
        background: url(~/static/img/cloud/youshi-right-titlebg2.png) no-repeat
          center;
        background-size: cover;
        .icon {
          position: absolute;
          ...
          width: 33px;
          height: 28px;
          background: url(~/static/img/cloud/youshi-right-title2.png) no-repeat
            center;
          background-size: cover;
        }
      }
  ...
  .container {
    ...
    .yingyong-left {
      ...
      .check {
        width: 210px;
        color: #ffffff;
        background: url(~/static/img/cloud/yingyongcheck.png) no-repeat center;
        background-size: cover;
      }
    }
    .yingyong-center {
    ...
    .yingyong-right {
      ...
      background: url(~/static/img/cloud/yingyonglist.png) no-repeat center;
      background-size: cover;
      .yingyong-list {
        width: 150px;
        height: 40px;
