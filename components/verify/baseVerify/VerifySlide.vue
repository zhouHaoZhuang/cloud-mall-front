<template>
  <div style="position: relative;" @mouseover="showImage = true" @mouseout="showImage = true">
    <!-- puzzle的情况 -->
    <div
      v-if="type === '2'"
    ...
    <div
      ...
      :style="{ width: setSize.barWidth, height: barSize.height, 'line-height': barSize.height }"
    >
...
export default {
  ...
  methods: {
    ...
    move: function(e) {
      if (this.status && this.isEnd == false) {
        ...
        if (this.type !== '1') {
          ...
          if (
            move_block_left >=
            this.barArea.offsetWidth - parseInt(parseInt(this.barSize.height) / 2) + 3
          ) {
    ...
    randSet: function() {
      ...
      var top =
        (rand1 * parseInt(this.setSize.imgHeight)) / 15 + parseInt(this.setSize.imgHeight) * 0.1
      var left =
        (rand2 * parseInt(this.setSize.imgWidth)) / 15 + parseInt(this.setSize.imgWidth) * 0.1
